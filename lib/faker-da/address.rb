module FakerDa
  class Address
    def self.da_zip_code
      da_zip_and_city[0]
    end

    #returns a Danish post district city name
    # =>'København K'
    def self.da_city
      da_zip_and_city[1]
    end

    #returns an array of corresponding zip code and city
    # => [1051, 'København K']
    def self.da_zip_and_city
      Da_zip_cities[rand(Da_zip_cities.length)]
    end

    # official Danish zip code list from 2008-11-14
    # http://postdanmark.dk/cms/da-dk/App/Postnumre/DownloadPostnummerfil.htm
    Da_zip_cities = [
      [1050, 'København K'],
      [1051, 'København K'],
      [1052, 'København K'],
